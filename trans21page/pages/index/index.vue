<template>
	<view class="toptt">实时代币检测-2.1前十持仓检测版（捆绑+重复度60%+前高30%+DEV20%以上持仓不推+2个以内为新钱包+诈骗5个及以上+10个以内差值在1为诈骗+DEV不跟卖）</view>
	<view class="topBt">
	...
	export default {
		data() {
			return {
				...
				adddressInfo: {},
				tkInfo: {},
				Host: "http://api21.pumpfind.homes",
		...
		methods: {
			buyOp(isp) {
				uni.request({
					url: this.Host + "/api/v1/test/op_robot?open=" + isp, // 请求地址
					method: 'GET', // 请求方式
