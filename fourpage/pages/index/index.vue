<template>
	<view class="toptt">实时代币检测(four.meme)</view>
	<view class="topBt">
	...
	export default {
		data() {
			return {
				...
				adddressInfo: {},
				tkInfo: {},
				Host: "http://fourapi.pumpfind.homes",
			...
			updateInfo() {
				...
				for (let j in this.dataList) {
					if (this.dataList[j].image.length == 0) {
						uni.request({
							url: "https://four.meme/meme-api/v1/private/token/get/v2?address=" + this.dataList[j].token, // 请求地址
							method: 'GET', // 请求方式
							success: (res) => { // 请求成功回调函数
